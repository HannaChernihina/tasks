...
// 1. Вычислить n-е число ряда Фибоначчи
...
// 1. вывод рядов Фибоначчи от переданного числа ( количество чисел фиб-чи) :
// через цикл  Итеративное решение
function fib(num){
        let arr2 = [0, 1];   //first value
    for(let i = 2; i < num ; i++){
